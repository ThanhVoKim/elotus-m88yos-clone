...
import { IResponsibleFooterProps } from './responsible-footer.type';

import './responsible-footer.style.scss';
import { footerResponsibleData } from 'src/mocks';

export const prefixClassResponsibleFooter = 'responsible-footer';

export const ResponsibleFooter: React.FC<IResponsibleFooterProps> = () => {
	return (
